...
| --- | --- | --- |
| [PleaseKnowSomeC/C++](#learning-c-and-cplusplus "-1_Please Know Some C/C++") | If you have programmed Java, Python, etc. you should be ready to start this Arduino class and pick up C-language on the way. If you have never done any programming, please sign up for the [C for Arduino Class](https://github.com/Mark-MDO47/CforArduinoClass "C for Arduino Class"). One or the other of programming experience or the [C for Arduino Class](https://github.com/Mark-MDO47/CforArduinoClass "C for Arduino Class") is a pre-requisite for the Arduino class. | <img src="https://github.com/Mark-MDO47/ArduinoClass/blob/master/99_Resources/Images/KandRbook.png" width="142" alt="Image of Kernighan and Ritchie C language book"> |
