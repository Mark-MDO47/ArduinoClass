...
| --- | --- | --- |
| [-1_Please Know Some C/C++](https:#learning-c-and-cplusplus "-1_Please Know Some C/C++") | If you have never done any programming, please learn a little about C and C++ before starting the class. Thanks!<br>I plan to add another (very) short class on C language for those without programming experience; this will be a pre-requisite for the Arduino class. | <img src="https://github.com/Mark-MDO47/ArduinoClass/blob/master/99_Resources/Images/KandRbook.png" width="142" alt="Image of Kernighan and Ritchie C language book"> |
