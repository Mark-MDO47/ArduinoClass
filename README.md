...
| --- | --- | --- |
| [PleaseKnowSomeC/C++](#learning-c-and-cplusplus "-1_Please Know Some C/C++") | If you know C/C++ you are good to go for this Arduino class! If you have programmed Java, Python, or some other text-based programming language, you should be ready to start this Arduino class and pick up C-language on the way. If you have never done any programming in any language, please sign up for the [C for Arduino Class](https://github.com/Mark-MDO47/CforArduinoClass "C for Arduino Class"). One or the other of programming experience or the [C for Arduino Class](https://github.com/Mark-MDO47/CforArduinoClass "C for Arduino Class") is a pre-requisite for the Arduino class. | <img src="https://github.com/Mark-MDO47/ArduinoClass/blob/master/99_Resources/Images/KandRbook.png" width="142" alt="Image of Kernighan and Ritchie C language book"> |
...
- One or the other of programming experience or the [C for Arduino Class](https://github.com/Mark-MDO47/CforArduinoClass "C for Arduino Class") is a pre-requisite for the Arduino class. 
...
If you search you might find the "mass-market paperback" of **The C Programming Language** at around $20 or maybe a used copy for even less.<br>
