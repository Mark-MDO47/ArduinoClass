...
| [01_BlinkingLED](https://github.com/Mark-MDO47/ArduinoClass/tree/master/01_BlinkingLED "01_BlinkingLED") | Blink some simple LEDs, control blinking using a button, display diagnostic messages using USB serial port.<br>Discusses ways to power Arduino, program persistence, use of PROGMEM to lower usage of RAM. | <img src="https://www.circuitstoday.com/wp-content/uploads/2018/02/Arduino-Nano-Pinout.jpg" width="142" alt="CircuitsToday.com picture of Arduino Nano"> |
| [02_PersistenceOfVision](https://github.com/Mark-MDO47/ArduinoClass/tree/master/02_PersistenceOfVision "02_PersistenceOfVision") | Fool your vision system with RGB LEDs, control with button and with keyboard via USB serial port. Consists of setup and four projects.<br>Discusses WS2812B addressable RGB LEDs, storage of configuration information in EEPROM. | <img src="https://protosupplies.com/wp-content/uploads/2020/09/WS2812-RGB-8-LED-Stick-Module-In-Operation.jpg" width="150" alt="protosupplies.com picture of RGB 8 LED Stick Module in operation"> |
