...
If it is not installed, install it. Choose the library that says "By Daniel Garcia" Below is a picture of the Arduino IDE Library Manager showing FastLED library is installed<br>
