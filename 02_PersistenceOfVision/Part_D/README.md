...
Copy the latest .ino file from Part C (either HelloWorld.ino or AllThePatterns_RedOrRainbow.ino, depending on whether you did the extra credit) into a directory named DemoReel with filename DemoReel.ino, then open it in the Arduino IDE.
...
- Change our variable name **fastled_array** to **leds** everywhere it appears
