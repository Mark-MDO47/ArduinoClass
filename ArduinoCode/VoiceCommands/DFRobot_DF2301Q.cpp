...
#ifdef MDO47_USING_HardwareSerial
...
#endif // MDO47_USING_HardwareSerial

// #if defined(ARDUINO_AVR_UNO)||defined(ESP8266) // modified Mark-MDO47
DFRobot_DF2301Q_UART::DFRobot_DF2301Q_UART(SoftwareSerial *softSerial)
{
  softSerial->begin(DF2301Q_UART_BAUDRATE);
  _ser = softSerial;
}
#if defined(ESP32) // modified Mark-MDO47
#abort ESP32
