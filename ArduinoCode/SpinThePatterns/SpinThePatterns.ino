...
static uint8_t peas_pattern[PEAS_CALLS_THEN_REPEAT] = { 0xFE, 0x01, 0x0E, 0x01, 0xFE, 0x00, 0xFF, 0x18, 0x18, 0x18, 0xFF, 0x00, 0x81, 0xFF, 0x81, 0x00, 0xFF, 0x98, 0x94, 0x63, 0x00, 0x01, 0x00, 0xFF, 0x01, 0x01, 0x01, 0x00, 0xFF, 0x89, 0x89, 0x89, 0x00, 0xFF, 0x81, 0x42, 0x3C, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x90, 0x90, 0x60, 0x00, 0xFF, 0x89, 0x89, 0x89, 0x00, 0x00, 0x1F, 0x68, 0x88, 0x68, 0x1F, 0x00, 0x00, 0x72, 0x89, 0x89, 0x46, 0x00, 0xF9, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };

#define FLAG_CALLS_THEN_REPEAT 22  // the Flag Red/White/Blue pattern does this many calls then repeats
static uint8_t flag_pattern_red[FLAG_CALLS_THEN_REPEAT] = { 0x0A,0x0A,0x0A,0x0A,0x0A,0xAA,0xAA,0xAA,0xAA,0xAA,0xAA,0xAA,0xAA,0xAA,0xAA,0xAA,0x00,0x00,0x00,0x00,0x00,0x00 };
static uint8_t flag_pattern_white[FLAG_CALLS_THEN_REPEAT] = { 0x54,0xA4,0x54,0xA4,0x04,0x54,0x54,0x54,0x54,0x54,0x54,0x54,0x54,0x54,0x54,0x54,0x00,0x00,0x00,0x00,0x00,0x00 };
static uint8_t flag_pattern_blue[FLAG_CALLS_THEN_REPEAT] = { 0xA0,0x50,0xA0,0x50,0xF0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00 };
...
static uint8_t * gPatternsBits[PATTERN_1BIT_MAX_NUM]   = { sawtooth_pattern_bits, oval_pattern_bits, hello_pattern_bits, peas_pattern };
static uint8_t * g_RWB_pattern_bits[3] = { flag_pattern_red, flag_pattern_white, flag_pattern_blue };
