...
The **I2C** version seems to work a little better than the **UART** version and did not require hacking up the DFRobot library code. Both versions are listed below:
